...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        input_box = self.browser.find_element_by_id('id_new_item')
        input_box.send_keys("Use peacock feathers to create a fly")
        input_box.send_keys(Keys.ENTER)

        # The page updates again and shows both items in her list
        self.wait_for_row_in_list_table('1: Buy peacock feathers')
        self.wait_for_row_in_list_table("2: Use peacock feathers to create a fly")
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## Edith's is coming through from cookies
        self.browser.quit()
        self.browser = webdriver.Firefox()
    ...
    def test_layout_and_styling(self):
        ...
        # She notices the input_box is nicely centered
        inputbox = self.browser.find_element_by_id('id_new_item')
