...
class ItemModelTest(TestCase):
    ...
    def test_CAN_save_same_item_in_different_lists(self):
        ...
        Item.objects.create(list=list_, text="blastoise")
        item2 = Item.objects.create(list=other_list_, text="blastoise")
        item2.full_clean() # Should not raise ValidationError
...
class ListModelTest(TestCase):
    ...
    def test_list_shared_with_contains_users_on_sharing(self):
        list_ = List.objects.create()
        user = User.objects.create(email="testuser1@example.com")
